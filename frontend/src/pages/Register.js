          ...
          <div className="bg-white rounded-2xl max-w-lg w-full flex flex-col border border-slate-200 shadow-2xl overflow-hidden max-h-[85vh]">
            <div className="p-6 overflow-y-auto">
              ...
              <div className="space-y-4 text-sm text-slate-600">
                <p><strong>1. Собираемые данные:</strong> В рамках использования закрытого контура мониторинга ИБ мы собираем следующие данные: ФИО, корпоративный адрес электронной почты, зашифрованный хэш пароля, ключи аутентификации и логи действий.</p>
                ...
                <p><strong>3. Безопасность и хранение:</strong> Все данные хранятся на внутренних серверах в изолированной сети. Ключи доступа обрабатываются исключительно на вашем личном устройстве, сервер получает только обезличенный криптографический публичный ключ.</p>
